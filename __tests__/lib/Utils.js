 ...
 */
const BASE64_URL_ENCODED__RE = /^[-\w]+$/;
 ...
 *   Defaults to `false`.
 */
const assertIsCursorLike = (value, optional = false) => {
  if (!optional || value) {
 ...
 *   Defaults to `false`.
 */
const assertIso8601Like = (value, optional = false) => {
  if (!optional || value) {
...
const assertCompactIso8601Like = (value) => {
 ...
 */
const assertIsJwtToken = (presumedToken) => {
